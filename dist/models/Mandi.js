...
// ============================================================
const MandiSchema = new mongoose_1.Schema({
    mandiCode: {
        type: String,
        required: true,
        unique: true,
...
MandiSchema.virtual("lat").get(function () {
    return this.location.coordinates[1];
});
MandiSchema.virtual("lng").get(function () {
    return this.location.coordinates[0];
});
exports.Mandi = (0, mongoose_1.model)("Mandi", MandiSchema);
exports.default = exports.Mandi;
