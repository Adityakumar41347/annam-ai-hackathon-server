...
PriceAlertSchema.index({ farmer: 1, mandi: 1, crop: 1, alertType: 1 }, { unique: true });
exports.PriceAlert = (0, mongoose_1.model)("PriceAlert", PriceAlertSchema);
exports.default = exports.PriceAlert;
